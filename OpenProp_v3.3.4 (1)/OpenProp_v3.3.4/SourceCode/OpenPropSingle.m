...
function OpenPropSingle
    ...
    XCoD_def        = [0.0700 0.0833 0.09 0.099 0.1045 0.1130 0.1129 0.1081 0.0968 0.0750 0.0558 0];     % chord to diameter ratio at XR
    ...
    % t0oc0_def       = [0.2055 0.1553 0.1180 0.09016 0.06960 0.05418 0.04206 0.1321 0.03228 0.03160];     % Thickness to chord ratio at XR
    ...
    N_def           = 700;                                      % Propeller speed [RPM]
    D_def           = 0.35;                                        % Propeller diameter [m]
    T_def           = 225;                                    % Required thrust [N]
    Vs_def          = 5;                                        % Ship speed [m/s]
    Dhub_def        = 0.086;                                      % Hub diameter [m]
